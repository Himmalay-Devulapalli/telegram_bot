...
def echo(update,context):
    # the update instance will be holding the current request to bot
    #update.message.text will give you the message sent by the user
    user_msg=update.message.text

    #to send reply back to user,use reply_text method and pass the text you wanted to send
    #here i received the user message in user_msg and sent back the same message to user
    #if the user send hello it will respond back with exactly same message 'hello'
